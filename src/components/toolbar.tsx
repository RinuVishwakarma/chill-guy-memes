        ...
        <div className="flex items-center space-x-2 p-2 text-2xl md:justify-center">
          ...
          {hasBackgroundImage && (
            <Button
              ...
              className="rounded-full hover:animate-jelly tooltip shrink-0"
            >
              <span className="tooltiptext">Remove Background</span>
          ...
          <Button
            ...
            variant="outline"
            size={"icon"}
            className={`rounded-full hover:animate-jelly tooltip shrink-0 ${drawingSettings.isDrawing ? 'bg-gray-200' : ''}`}
          >
          ...
          {drawingSettings.isDrawing && (
            <Button
              ...
              variant="outline"
              size={"icon"}
              className={`rounded-full hover:animate-jelly tooltip shrink-0 ${drawingSettings.isEraser ? 'bg-gray-200' : ''}`}
            >
